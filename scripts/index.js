...
const printCount = () => {
  ...
  if(countDays > 0) {
    ...
    beforeActionText.textContent = 'Акция началась';
    countDaysText.textContent ='';
  }

}

printCount();
buttonOpenMenu.addEventListener('click', handleSwitchMobileMenu);
